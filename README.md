...
```text
reca.sh --metadata --json /home/chris/Music > myMusic.json
```
...
and selecting other rows. Continue holding down the ctrl button and select as many rows as you want on a many pages as you want.
...
will begin shortly.
- Rows selected on any page of the data are used to generate the playlist. For example, if you have 100 rows of music files, and select 5 rows on page 1 and 4 rows on page three, all 9 rows will be used to generate the playlist.
...
- Supported on the latest versions Firefox, Chrome, and Edge as of March 2026. Compatibility is unknown on other browsers or previous
